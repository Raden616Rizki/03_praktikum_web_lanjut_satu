...
Route::prefix('product') -> group (function () {
    Route::get('/spot', [ProductsController::class, 'spot']);
    Route::get('/farm', [ProductsController::class, 'farm']);
    Route::get('/kopi', [ProductsController::class, 'kopi']);
    Route::get('/strawberry', [ProductsController::class, 'strawberry']);
}) -> name('product');
